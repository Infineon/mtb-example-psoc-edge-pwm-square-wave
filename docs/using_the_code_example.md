...
The following example clones the "[PWM square wave](https://github.com/Infineon/mtb-example-psoc-edge-pwm-square-wave)" application with the desired name "PwmSquareWave" configured for the *KIT_PSE84_EVAL_EPC2* BSP into the specified working directory, *C:/mtb_projects*:

   ```
   project-creator-cli --board-id KIT_PSE84_EVAL_EPC2 --app-id mtb-example-psoc-edge-pwm-square-wave --user-app-name PwmSquareWave --target-dir "C:/mtb_projects"
   ```
